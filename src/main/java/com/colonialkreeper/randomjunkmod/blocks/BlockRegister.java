...
public class BlockRegister {
    ...
    private static RegistryKey<Block> keyOfBlock(String name) {
        return RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(RandomJunkMod.MOD_ID, name));
    }

    private static RegistryKey<Item> keyOfItem(String name) {
        return RegistryKey.of(RegistryKeys.ITEM, Identifier.of(RandomJunkMod.MOD_ID, name));
    }

    public static void registerBlocks() {
        RandomJunkMod.LOGGER.info("Registering Items for " + RandomJunkMod.MOD_ID);
    }
